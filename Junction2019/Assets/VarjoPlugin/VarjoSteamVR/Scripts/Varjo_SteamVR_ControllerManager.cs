...
namespace Varjo
{
    public class Varjo_SteamVR_ControllerManager : MonoBehaviour
    {
        ...
        Varjo_SteamVR_Events.Action inputFocusAction, deviceConnectedAction, trackedDeviceRoleChangedAction;
        ...
        void OnEnable()
        {
            ...
            for (int i = 0; i < Varjo_SteamVR.connected.Length; i++)
                if (Varjo_SteamVR.connected[i])
