...
namespace Varjo
{
    public class Varjo_SteamVR : System.IDisposable
    {
        ...
        private static Varjo_SteamVR _instance;
        public static Varjo_SteamVR instance
        {
            get
            {
#if UNITY_EDITOR
        ...
        static Varjo_SteamVR CreateInstance()
        {
            return new Varjo_SteamVR();
        }
        ...
        public Varjo_SteamVR_Utils.RigidTransform[] eyes { get; private set; }
        ...
        {
            Varjo_SteamVR.initializing = initializing;
        }

        private void OnCalibrating(bool calibrating)
        {
            Varjo_SteamVR.calibrating = calibrating;
        }

        private void OnOutOfRange(bool outOfRange)
        {
            Varjo_SteamVR.outOfRange = outOfRange;
        }

        private void OnDeviceConnected(int i, bool connected)
        {
            Varjo_SteamVR.connected[i] = connected;
        }
        ...
        {
            Varjo_SteamVR_Events.Initializing.Remove(OnInitializing);
            Varjo_SteamVR_Events.Calibrating.Remove(OnCalibrating);
            Varjo_SteamVR_Events.OutOfRange.Remove(OnOutOfRange);
            Varjo_SteamVR_Events.DeviceConnected.Remove(OnDeviceConnected);
            Varjo_SteamVR_Events.NewPoses.Remove(OnNewPoses);
